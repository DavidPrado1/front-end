    ...
    <v-layout align-start>
        ...
        <v-flex>
            ...
            <template v-slot:top>
                ...
                flat
                >
                <v-toolbar-title>Estudiantes Matriculados</v-toolbar-title>
                <v-divider
                    class="mx-4"
                    inset
                    vertical
                ...
                >
                    ...
                    <v-card-text>
                        ...
                        <v-row>
                            ...
                            >
                            <v-text-field
                                v-model="editedItem.id_estudiante"
                                label="Semestre"
                                clearable
                                hide-details="auto"
                                readonly 
    ...
    export default{    
        data(){ 
            return { 
                ...
                { text: 'Nro de Recibo', value: 'recibo' },
        ...
        methods:{
            ...
            initialize () {
                ...
                axios.post(this.postURL + '/estudiantesMatriculados',this.test,{config_request}).then((res) => {  
                    console.log(res.data);
                ...
                deleteItemConfirm () {
                    ...
                    axios.post(this.postURL + '/delete_estudianteMatriculado', this.editedItem,{config_request})
                        .then(res => {                      
                            console.log(res.data);
                ...
                if (this.editedIndex > -1) {
                    ...
                    axios.put(this.postURL + '/create_estudianteMatriculado', this.editedItem, { config_request })
                        .then(res => {                                         
                            console.log(res.data);
