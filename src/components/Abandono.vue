<template>
    ...
    <v-layout align-start>
        ...
        <v-flex>
            ...
            <template v-slot:top>
                ...
                flat
                >
                <v-toolbar-title>Estudiantes Abandono</v-toolbar-title>
                <v-divider
                    class="mx-4"
                    inset
                    vertical
    ...
    export default{    
        ...
        methods:{
            ...
            initialize () {
                axios.post(this.postURL + '/estudiantesAbandono').then((res) => {  
                ...
                axios.post(this.postURL + '/estudianteAbandono',this.test,{config_request}).then((res) => {  
                    console.log(res.data);
                    this.lista = res.data;            
                })
                .catch((error) => {
                ...
                if (this.editedIndex > -1) {
                    ...
                    axios.put(this.postURL + '/create_estudianteAbandono', this.editedItem, { config_request })
                        .then(res => {                                         
                            console.log(res.data);
